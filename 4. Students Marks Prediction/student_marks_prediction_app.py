...
model = pickle.load(open(r"C:\Users\vijayram\A VS Code\4. Students Marks Prediction\students_marks_prediction.pkl", 'rb'))
...
def handle_login():
    ...
    user_credentials.to_csv(r'C:\Users\vijayram\A VS Code\4. Students Marks Prediction\user_credentials_sample.csv', index=False)
...
def predict():
    ...
    df.to_csv(r'C:\Users\vijayram\A VS Code\4. Students Marks Prediction\smp_data_from_app.csv', index=False)
