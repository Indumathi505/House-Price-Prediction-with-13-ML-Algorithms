...
# Load dataset
data = pd.read_csv(r"C:\Users\vijayram\OneDrive\Desktop\Python_NIT\NIT\Datasets_csv files\USA_Housing.csv")
...
for name, model in models.items():
    ...
    with open(f'{name}.pkl', 'wb') as f:  # wb =  with binary  ------ f = format 
        pickle.dump(model, f)
